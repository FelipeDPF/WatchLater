    ...
    return (
        <>
            <Card className="card" style={{ maxWidth: "600em", flexGrow: 0 }}>
                <Card.Img onClick={() => setModalShow(true)} variant="bottom" src={`https://image.tmdb.org/t/p/w185_and_h278_bestv2/${movie.poster_path}`} alt={movie.title + ' poster'} />
            ...
            >
                ...
                <Modal.Body style={{ maxWidth: "1600px", backgroundPosition: 'center', backgroundSize: 'cover', backgroundImage: `url(${`https://image.tmdb.org/t/p/original/${movie.backdrop_path}`})`}}>
                ...
                <Button onClick={() => addMovieToWatchList(movie)} variant="warning">Add to WatchList</Button>
                </Modal.Footer>
            </Modal>
        </>
    );
